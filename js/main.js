...
===========================================================
🔥 FIX IMPORTANTE:
Cerrar menú hamburguesa al seleccionar cualquier opción
===========================================================
*/
...
// Cerrar menú hamburguesa al seleccionar cualquier opción del menú móvil
function closeMobileMenu() {
  navLinks.style.display = "none";
  menuOverLay.style.display = "none";
}

// Enlaces internos (#home, #menu, #about, etc.)
document.querySelectorAll('a[href^="#"]').forEach(link => {
  link.addEventListener("click", closeMobileMenu);
});

// Botón "Menu" (clase menuNav)
document.querySelectorAll(".menuNav").forEach(btn => {
  btn.addEventListener("click", closeMobileMenu);
});

// Botón "Contact Us" (clase contactUsNav)
document.querySelectorAll(".contactUsNav").forEach(btn => {
  btn.addEventListener("click", closeMobileMenu);
});
